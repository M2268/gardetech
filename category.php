        ...
        <div class="col-md-10 col-lg-10 col-xs-12">
            <div class="products">
                ...
                if (isset($_GET['catID'])) {
                    ...
                    $queryCat = "SELECT * FROM categories where cat_id = {$get_cat_id}";
                    $select_category = mysqli_query($connection, $queryCat);

                    while ($row2 = mysqli_fetch_assoc($select_category)) {
                        $cat_name = $row2['cat_name'];
                        //$cat_image = $row['cat_image'];
                        //$product_content = substr($row['product_content'], 0, 200);
                        echo "<div class=\"r-products\"><h3>".$cat_name."</h3></div>";
                        echo "<hr class=\"rp\">";
                    }
                        ?>
                    <!--
